...
export class RestClient {
    // public async requestSimple<T extends unknown[] = unknown[]>(url: string, request: RequestInit, body: Record<string, string>): Promise<ApiResponse<string[], T>> {
    ...
    // public async request<T extends unknown[] = unknown[]>(url: string, request: RequestInit): Promise<ApiResponse<string[], T>> {
